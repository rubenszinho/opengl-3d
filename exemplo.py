...
# 
# Nos slides da Aula, descrevemos o funcionamento desse formato.
...
### carregando textura equivalente e definindo um id (buffer): use um id por textura!
load_texture_from_file(1,'texturas/pedra.jpg')

modelo = load_model_from_file('modelos/casa.obj')
...
### carregando textura equivalente e definindo um id (buffer): use um id por textura!
load_texture_from_file(2,'texturas/casa.jpg')
